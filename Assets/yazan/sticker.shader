...
Shader "Shadero Customs/sticker"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_PageCurl_movement_1("_PageCurl_movement_1", Range(-6, 6)) = -0.589
_PageCurl_rotation_1("_PageCurl_rotation_1", Range(-1, 1)) = 0.175
_PageCurl_Curve_1("_PageCurl_Curve_1", Range(0, 0.3)) = 0.135
_PageCurl_Shadow_1("_PageCurl_Shadow_1", Range(0, 8)) = 4.656
