...
public class CafeteriaUIController : MonoBehaviour
{
    ...
    public void OnRetry()
    {
        // Note: Because all your rooms are inside one giant "MainMap" scene, 
        // you might want to call your CafeteriaLevel's Reset/Retry functions 
        // directly from your UI buttons instead of using this SceneManager reload!
